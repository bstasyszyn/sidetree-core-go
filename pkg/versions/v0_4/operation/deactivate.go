...
func (p *OperationParser) parseDeactivateRequest(payload []byte) (*model.DeactivateRequest, error) {
...
func (p *OperationParser) validateDeactivateRequest(req *model.DeactivateRequest) error {
	if req.DidSuffix == "" {
